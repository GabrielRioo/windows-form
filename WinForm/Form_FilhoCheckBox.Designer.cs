namespace WinForm
{
	partial class Form_FilhoCheckBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.cb_navio.Location = new System.Drawing.Point(12, 61);
			...
			this.cb_navio.CheckedChanged += new System.EventHandler(this.cb_navio_CheckedChanged_1);
			// 
			// cb_aviao
			// 
			...
			this.cb_aviao.CheckedChanged += new System.EventHandler(this.cb_aviao_CheckedChanged_1);
			// 
			// cb_carro
			// 
